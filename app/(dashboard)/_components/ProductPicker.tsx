...
function ProductPicker({ onChange }: Props) {
  ...
  <PopoverContent className="w-[200px] p-0 max-h-[300px] overflow-y-auto"> {/* Ensure PopoverContent is scrollable */}
    <Command onSubmit={(e) => e.preventDefault()}>
      ...
      <CommandGroup>
        <CommandList className="max-h-[300px] overflow-y-auto"> {/* Ensure CommandList scrolls */}
