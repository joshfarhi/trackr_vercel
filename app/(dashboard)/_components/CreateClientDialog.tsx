...
import { CreateClient } from "@/app/(dashboard)/_actions/clients";
...
function CreateClientDialog({  successCallback, trigger }: Props) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Clients are used to group your transactions
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    This is how your client will appear in the app
                  </FormDescription>
                </FormItem>
              )}
            />
